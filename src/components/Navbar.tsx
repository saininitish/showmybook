      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex relative group">
            ...
            <input
              type="text"
              className="bg-white/5 border border-white/10 text-sm rounded-full pl-10 pr-4 py-2 w-64 md:w-80 focus:outline-none focus:border-primary/50 focus:bg-white/10 transition-all placeholder:text-text-muted text-white"
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div className="flex items-center gap-3">
            <button className="p-2 text-text-muted hover:text-white transition-colors md:hidden">
            ...
            <div className="relative">
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 glass-panel rounded-2xl p-4 shadow-[0_10px_40px_rgba(0,0,0,0.5)] border-white/10 z-50 animate-fade-in origin-top-right">
                  ...
                  <div className="space-y-2">
                    ...
                    <Link href="/movies/4" className="flex gap-3 hover:bg-white/5 p-2 rounded-xl transition-colors group">
                      <div className="w-12 h-16 relative rounded-lg overflow-hidden shrink-0 border border-white/10">
                        <Image src="https://image.tmdb.org/t/p/w500/9gk7adHYeDvHkCSEqAvQNLV5ucge.jpg" alt="Inception" fill className="object-cover" sizes="48px" />
                      </div>
                      <div className="flex-1">
